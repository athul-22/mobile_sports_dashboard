        ...
        <header className="app-bar">
            <div className="left-section">
                <button className="icon-button" style={{ marginLeft: '' }}>
                    <div style={{ height: '55px', width: '55px', backgroundColor: '#2339aa', borderRadius: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={UserIcon} alt="User Icon" style={{ height: '40px', width: '40px' }} />
                    </div>
                </button>
            ...
            <div className="right-section" style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center',width:'100%',marginRight:'20px' }}>
                    <div style={{ height: '45px', width: '45px', backgroundColor: '#2339aa', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 5px' }}>
                        <img src={bell} alt="Bell Icon" style={{ height: '30px', width: '30px' }} />
                    </div>
                    <div style={{ height: '45px', width: '45px', backgroundColor: '#2339aa', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 5px' }}>
                        <img src={NOTIFICATION} alt="Notification Icon" style={{ height: '30px', width: '30px'}} />
                    </div>
            </div>
